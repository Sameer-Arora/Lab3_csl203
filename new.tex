...
\maketitle
\begin{abstract}
With the proliferation of mobile video cameras, it is becoming easier for users to capture videos of live performances and socially
...
distance, producing a rather monotonous video clip. At such performances, however, multiple video clips can be captured by different users, likely from different angles and distances. These videos
...
earlier works select video shots merely based on the quality of currently available videos. In real video editing process, however, recent selection history plays an important role in choosing future
...
MoViMash framework. \vspace{0.1cm} \\
\textbf{Categories and Subject Descriptors:} I.2.10 [Vision and Scene Understanding]: Video Analysis  \vspace{0.05cm}\\
\textbf{General Terms:} Algorithms, Design.  \vspace{0.05cm}\\
\textbf{Keywords:} Mobile Video, Virtual Director, Video Mashup.
\end{abstract}

\section{Introduction}
<<<<<<< HEAD
I am sameer user2 .I am editing the file.
=======
I am sammerr tryin the git .The file is bieng edited by me.
>>>>>>> e65e7f76d2d8af4d749abb7471c966a1ec12ffde
...
over 2,500 respondents by Photobucket reveals that 45$\%$ of the respondents use mobile devices to shoot video at least once weekly during the summer of 2011, validating the significant increase in
the amount of mobile video uploaded to Photobucket's video sharing website (14$\times$ in Summer 2011 compared to December 2010) \cite{2}. 
